// Pannello di lettura per i contenuti STORED (scheda didattica salvata nel DB di art-creator).
    ...
    <aside className="analysis-panel" aria-live="polite">
      ...
      {!hasSelection && (
        <div className="empty-analysis">
          ...
          <div className="empty-tip"><Icon name="info" size={16} /> I contenuti provengono dalla scheda didattica pubblicata in art-creator: nessuna generazione al volo.</div>
        </div>
      )}
